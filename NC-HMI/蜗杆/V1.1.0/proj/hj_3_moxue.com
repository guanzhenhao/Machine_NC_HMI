...
//M(Mask0/$85020/"blank.png"/)
	...
	DEF VAR_GRD2=(R///$85173,$85173,,/WR2/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[3]"/380,70,150/460,70,70/7,4);蜗杆模数
	DEF VAR_GRD3=(R///$85104,$85104,$85043,/WR1/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[5]"/380,90,190/460,90,70/3,4);蜗杆螺距
	...
	DEF VAR8=(R/*0=$85127,1=$85128,2=$85129,3=$85130,4=$85131//$85101,$85101,,/WR2,ac1//"/NC/_N_NC_GD2_ACX/GRIND[16]"/0,0,0/350,10,100/7,4);公制轴向模数/英制轴向模数/公制法向模数/英值法向模数/公制螺距
	DEF VAR9=(R/*0=$85087,1=$85088//$85089,$85089,,/WR2/"panel_5_1_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[6]"/0,0,0/260,10,70/7,4);是否首件对刀
	DEF VAR10=(R/*0=$85191,1=$85192//$85089,$85089,,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[28]"/0,0,0/380,10,70/3,4);0=单导程/1=双导程
	;;按键定义
	HS1=($85001,ac7,se3)
	HS2=($85003,ac7,se1)
	HS3=($85002,ac7,se1)
	...
	END_PRESS
	PRESS(HS3)
		LM("Mask0","hj_3_gongyi.com",0);修整界面
	END_PRESS
	PRESS(HS4)
	...
	PRESS(VS2)
		VAR10.VAL=1
		LM("Mask1","hj_3_moxue.com",0);双齿面单独磨削
	END_PRESS
	PRESS(VS8)
		EXIT
	END_PRESS
	...
	SUB(UP4)
		...
		ENDIF
		IF VAR8.VAL==2;公制法向模数
			VAR_GRD3.VAL=VAR_GRD2.VAL*PI;模数计算螺距
		ENDIF
		IF VAR8.VAL==3;英制发向模数
			VAR_GRD3.VAL=25.4*VAR_GRD2.VAL*PI;模数计算螺距
		ENDIF
	END_SUB
//END
...
//M(Mask1/$85020/"blank.png"/)
	...
	;;锥度
	DEF VAR_GRD7=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_5_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[14]"/40,240,80/75,240,30/);是否有锥度
	DEF VAR_GRD8=(R7/-1,1//$85160,,,/WR2/"panel_5_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[15]"/0,0,0/120,240,70/7,4);锥度值
	;;自动螺旋升角
	DEF VAR_GRD10=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2/"panel_5_9_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[6]"/40,260,80/75,260,30/);螺旋升角自动计算
	DEF VAR_GRD11=(I/0,45//$85055,,,$85042/WR2/"panel_5_10_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[9]"/0,0,0/120,260,70/7,4);度
	DEF VAR_GRD12=(I/0,59//$85056,,,$85053/WR2/"panel_5_11_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[10]"/0,0,0/150,260,70/7,4);分
	DEF VAR_GRD13=(I/0,59//$85057,,,$85054/WR2/"panel_5_12_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[11]"/0,0,0/180,260,70/7,4);秒
	DEF VAR_GRD14=(R/0,400//$85107,$85107,,$85043,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[21]"/25,280,190/120,280,120/7,4);分度圆直径
	;;工件装夹位
	...
	DEF VAR6=(R3/-0.5,0.5//$85175,$85175,$85043,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[13]"/380,330,190/460,330,70/7,4);偏刀调整
	DEF VAR7=(R3/-0.5,0.5//$85105,$85105,$85043,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[19]"/380,350,190/460,350,70/7,4);导程补偿
	DEF VAR8=(R/*0=$85127,1=$85128,2=$85129,3=$85130//$85101,$85101,,/WR2,ac1//"/NC/_N_NC_GD2_ACX/GRIND[16]"/0,0,0/350,10,100/7,4);公制轴向模数/英制轴向模数/公制法向模数/英值法向模数/公制螺距
	DEF VAR9=(R/*0=$85087,1=$85088//$85089,$85089,,/WR2/"panel_5_1_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[6]"/0,0,0/260,10,70/7,4);是否首件对刀
	DEF VAR10=(R/*0=$85191,1=$85192//$85089,$85089,,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[28]"/0,0,0/380,10,70/3,4);0=单导程/1=双导程
	;;按键定义
	HS1=($85001,ac7,se3)
	...
	PRESS(VS2)
		VAR10.VAL=0
		LM("Mask0","hj_3_moxue.com",0);标准磨削
	END_PRESS
	PRESS(VS8)
		EXIT
	END_PRESS
