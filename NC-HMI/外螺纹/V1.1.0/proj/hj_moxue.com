...
;;基础参数
	...
	DEF VAR_GRD6=(R///$85165,$85145,$85043,/WR2/"panel_1_7_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[14]"/380,130,190/460,130,70/7,4);对刀起始位置
;;锥度
...
;;其他参数
	DEF VAR0=(I/*0=$85166,1=$85167//,,,/WR2/"panel_1_0_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[12]"/380,10,190/460,10,70/3,4);加工模式
	...
	DEF VAR9=(R/*0=$85087,1=$85088//$85089,$85089,,/WR2/"panel_1_1_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[6]"/0,0,0/290,10,70/3,4);是否首件对刀
	DEF VAR10=(R/*0=$85146,1=$85147,2=$85148//$85145,$85145,,/WR2/"panel_1_13_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[13]"/0,0,0/290,30,70/3,4);对刀位置选择
;;按键定义
	HS1=($85001,ac7,se3)
	HS2=($85003,ac7,se1)
	HS3=($85002,ac7,se1)
	...
	PRESS(HS2)
		...
		ENDIF
		IF VAR8.VAL==1
			LM("Mask1","hj_xiuzheng.com",0);修整界面
		ENDIF
		IF VAR8.VAL==2
