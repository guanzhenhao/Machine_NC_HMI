...
;;锥度
	...
	DEF VAR_GRD8=(I/-10,10//$85160,,,$85052/WR2/"panel_1_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[15]"/0,230,0/460,230,85/7,4);锥度分子,默认内螺纹大头往小头磨,外螺纹小头往大头磨
	DEF VAR_GRD9=(R2/0,800//$85161,,,/WR2/"panel_1_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[16]"/0,230,0/500,230,45/7,4);锥度分母
;;自动螺旋升角
...
;;其他参数
	...
	DEF VAR4=(R3///$85126,$85126,$85043,/WR2,ac3//"/NC/_N_NC_GD2_ACX/POSITION[8]"/380,290,190/460,290,70/7,4);磨削基准
	...
	DEF VAR9=(R/*0=$85087,1=$85088//$85089,$85089,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[6]"/0,0,0/290,10,70/3,4);是否首件对刀
;;按键定义
	HS1=($85001,ac7,se3)
	HS2=($85003,ac7,se1)
	HS3=($85002,ac7,se1)
