...
;;粗磨
    ...
    DEF POSITION_6=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[7]"/0,0,0/148,227,60/3,4);粗磨修整次数
    DEF POSITION_7=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[8]"/0,0,0/148,252,60/3,4);粗磨修整进给
    DEF POSITION_8=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[9]"/0,0,0/148,277,60/3,4);粗磨修整速度
    DEF POSITION_9=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[10]"/0,0,0/148,302,60/3,4);粗磨修整砂轮线速度
...
;;半精磨
    ...
    DEF POSITION_26=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[27]"/0,0,0/238,227,60/3,4);粗磨修整次数
    DEF POSITION_27=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[28]"/0,0,0/238,252,60/3,4);粗磨修整进给
    DEF POSITION_28=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[29]"/0,0,0/238,277,60/3,4);粗磨修整速度
    DEF POSITION_29=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[30]"/0,0,0/238,302,60/3,4);粗磨修整砂轮线速度
...
;;精磨
    ...
    DEF POSITION_46=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[47]"/0,0,0/328,227,60/3,4);粗磨修整次数
    DEF POSITION_47=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[48]"/0,0,0/328,252,60/3,4);粗磨修整进给
    DEF POSITION_48=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[49]"/0,0,0/328,277,60/3,4);粗磨修整速度
    DEF POSITION_49=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[50]"/0,0,0/328,302,60/3,4);粗磨修整砂轮线速度
...
;;终磨
    ...
    DEF POSITION_66=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[67]"/0,0,0/418,227,60/3,4);粗磨修整次数
    DEF POSITION_67=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[68]"/0,0,0/418,252,60/3,4);粗磨修整进给
    DEF POSITION_68=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[69]"/0,0,0/418,277,60/3,4);粗磨修整速度
    DEF POSITION_69=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[70]"/0,0,0/418,302,60/3,4);粗磨修整砂轮线速度
...
;;修整界面修整参数
    ...
    DEF VAR4=(I/*0=$85210,1=$85209//$85211,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[106]"/0,10,0/10,10,80/7,4);标准修整/自定义修整
