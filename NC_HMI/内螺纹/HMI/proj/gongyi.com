...
;;粗磨
    ...
    DEF POSITION_3=(R/0,0.2//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[4]"/0,0,0/130,161,60/7,4);粗磨头架转速
    ...
    DEF POSITION_7=(R/0,0.1//$85203,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[8]"/0,0,0/130,278,60/7,4);粗磨修整进给
...
;;半精磨
    ...
    DEF POSITION_23=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[24]"/0,0,0/220,161,60/7,4);半精磨头架转速
    ...
    DEF POSITION_26=(I///$85204,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[27]"/0,0,0/220,254,60/7,4);半精磨修整次数
    DEF POSITION_27=(R/0,0.1//$85204,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[28]"/0,0,0/220,278,60/7,4);半精磨修整进给
    DEF POSITION_28=(R///$85204,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[29]"/0,0,0/220,303,60/7,4);半精磨修整速度
    DEF POSITION_29=(R///$85204,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[30]"/0,0,0/220,326,60/7,4);半精磨修整砂轮线速度
    DEF POSITION_31=(R2///$85204,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[32]"/0,0,0/220,350,60/3,4);半精磨修整砂轮转速
;;精磨
    ...
    DEF POSITION_43=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[44]"/0,0,0/310,161,60/7,4);精磨头架转速
    ...
    DEF POSITION_46=(I///$85205,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[47]"/0,0,0/310,254,60/7,4);精磨修整次数
    DEF POSITION_47=(R/0,0.1//$85205,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[48]"/0,0,0/310,278,60/7,4);精磨修整进给
    DEF POSITION_48=(R///$85205,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[49]"/0,0,0/310,303,60/7,4);精磨修整速度
    DEF POSITION_49=(R///$85205,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[50]"/0,0,0/310,326,60/7,4);精磨修整砂轮线速度
    DEF POSITION_51=(R2///$85205,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[52]"/0,0,0/310,350,60/3,4);精磨修整砂轮转速
;;终磨
    ...
    DEF POSITION_63=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[64]"/0,0,0/400,161,60/7,4);终磨头架转速
    ...
    DEF POSITION_66=(I///$85206,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[67]"/0,0,0/400,254,60/7,4);终磨修整次数
    DEF POSITION_67=(R/0,0.1//$85206,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[68]"/0,0,0/400,278,60/7,4);终磨修整进给
    DEF POSITION_68=(R///$85206,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[69]"/0,0,0/400,303,60/7,4);终磨修整速度
    DEF POSITION_69=(R///$85206,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[70]"/0,0,0/400,326,60/7,4);终磨修整砂轮线速度
    DEF POSITION_71=(R2///$85206,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESSER[72]"/0,0,0/400,350,60/3,4);终磨修整砂轮转速
